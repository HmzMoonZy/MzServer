...
/// </summary>
public partial class TbRogueDungeon_endEvent
{
    ...
    public RogueDungeon_endEvent GetOrDefault(int key) => _dataMap.TryGetValue(key, out var v) ? v : null;
    public RogueDungeon_endEvent Get(int key) => _dataMap[key];
    public RogueDungeon_endEvent this[int key] => _dataMap[key];
