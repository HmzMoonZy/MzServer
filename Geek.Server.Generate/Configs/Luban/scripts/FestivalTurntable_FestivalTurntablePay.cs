...
{
    public FestivalTurntable_FestivalTurntablePay(JToken _buf) 
    {
    ...
    public static FestivalTurntable_FestivalTurntablePay DeserializeFestivalTurntable_FestivalTurntablePay(JToken _buf)
    {
