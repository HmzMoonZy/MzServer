...
{
public sealed partial class ServerList_serverList : Luban.BeanBase
{
    public ServerList_serverList(ByteBuf _buf) 
    {
        id = _buf.ReadInt();
    ...
    public static ServerList_serverList DeserializeServerList_serverList(ByteBuf _buf)
    {
        return new ServerList_serverList(_buf);
    }
    ...
    public const int __ID__ = -1241269537;
