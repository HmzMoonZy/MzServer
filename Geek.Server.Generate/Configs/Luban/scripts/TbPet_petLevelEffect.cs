...
/// </summary>
public partial class TbPet_petLevelEffect
{
    ...
    public Pet_petLevelEffect GetOrDefault(int key) => _dataMap.TryGetValue(key, out var v) ? v : null;
    public Pet_petLevelEffect Get(int key) => _dataMap[key];
    public Pet_petLevelEffect this[int key] => _dataMap[key];
