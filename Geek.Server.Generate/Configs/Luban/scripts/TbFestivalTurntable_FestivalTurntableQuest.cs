...
public partial class TbFestivalTurntable_FestivalTurntableQuest
{
    ...
    public TbFestivalTurntable_FestivalTurntableQuest(JArray _buf)
    {
        ...
        foreach(JObject _ele in _buf)
        {
            ...
            _v = global::HotFix.Cfg.FestivalTurntable_FestivalTurntableQuest.DeserializeFestivalTurntable_FestivalTurntableQuest(_ele);
            _dataList.Add(_v);
