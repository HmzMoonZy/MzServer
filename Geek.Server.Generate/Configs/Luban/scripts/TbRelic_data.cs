...
/// </summary>
public partial class TbRelic_data
{
    ...
    public Relic_data GetOrDefault(int key) => _dataMap.TryGetValue(key, out var v) ? v : null;
    public Relic_data Get(int key) => _dataMap[key];
    public Relic_data this[int key] => _dataMap[key];
