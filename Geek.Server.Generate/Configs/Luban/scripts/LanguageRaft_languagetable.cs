...
{
public sealed partial class LanguageRaft_languagetable : Luban.BeanBase
{
    public LanguageRaft_languagetable(ByteBuf _buf) 
    {
        id = _buf.ReadString();
    ...
    public static LanguageRaft_languagetable DeserializeLanguageRaft_languagetable(ByteBuf _buf)
    {
        return new LanguageRaft_languagetable(_buf);
    }
    ...
    public const int __ID__ = 894890892;
