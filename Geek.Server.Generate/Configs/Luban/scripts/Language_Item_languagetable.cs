...
{
public sealed partial class Language_Item_languagetable : Luban.BeanBase
{
    public Language_Item_languagetable(ByteBuf _buf) 
    {
        id = _buf.ReadString();
    ...
    public static Language_Item_languagetable DeserializeLanguage_Item_languagetable(ByteBuf _buf)
    {
        return new Language_Item_languagetable(_buf);
    }
    ...
    public const int __ID__ = 639965073;
