...
{
    public ServerList_serverRange(JToken _buf) 
    {
        ...
        { var __json0 = _obj.GetValue("LuckyKoiRange1"); int _n0 = (__json0 as JArray).Count; LuckyKoiRange1 = new string[_n0]; int __index0=0; foreach(JToken __e0 in __json0) { string __v0;  __v0 = (string)__e0;  LuckyKoiRange1[__index0++] = __v0; }   }
        { var __json0 = _obj.GetValue("LuckyKoiRange2"); int _n0 = (__json0 as JArray).Count; LuckyKoiRange2 = new string[_n0]; int __index0=0; foreach(JToken __e0 in __json0) { string __v0;  __v0 = (string)__e0;  LuckyKoiRange2[__index0++] = __v0; }   }
    ...
    public static ServerList_serverRange DeserializeServerList_serverRange(JToken _buf)
    {
