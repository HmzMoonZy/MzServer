...
/// </summary>
public partial class TbWorldBoss_Subsection
{
    ...
    public WorldBoss_Subsection GetOrDefault(int key) => _dataMap.TryGetValue(key, out var v) ? v : null;
    public WorldBoss_Subsection Get(int key) => _dataMap[key];
    public WorldBoss_Subsection this[int key] => _dataMap[key];
