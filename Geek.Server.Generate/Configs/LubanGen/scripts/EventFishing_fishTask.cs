...
{
public sealed partial class EventFishing_fishTask : Luban.BeanBase
{
    public EventFishing_fishTask(ByteBuf _buf) 
    {
        ID = _buf.ReadInt();
    ...
    public static EventFishing_fishTask DeserializeEventFishing_fishTask(ByteBuf _buf)
    {
        return new EventFishing_fishTask(_buf);
    }
    ...
    public const int __ID__ = -2016882516;
