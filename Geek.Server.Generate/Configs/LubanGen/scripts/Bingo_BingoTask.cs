...
{
public sealed partial class Bingo_BingoTask : Luban.BeanBase
{
    public Bingo_BingoTask(ByteBuf _buf) 
    {
        ID = _buf.ReadInt();
    ...
    public static Bingo_BingoTask DeserializeBingo_BingoTask(ByteBuf _buf)
    {
        return new Bingo_BingoTask(_buf);
    }
    ...
    public const int __ID__ = -542218748;
